...
public class CopyProp implements cfg.Visitor
{
  ...
  private boolean check(cfg.operand.T operand, java.util.HashSet<cfg.stm.T> set)
  {
	  ...
	  if(((cfg.stm.Move)target).src instanceof cfg.operand.Var) {
  ...
  {
	  if(control.Control.isTracing("copyprop.loop")){
		  System.out.println("========= block before copyprop========");
...
//		  System.out.println("s after: " + s + " " + this.changed);
	  ...
	  if(control.Control.isTracing("copyprop.loop")){
		  System.out.println("========= block after copyprop========");
		  System.out.println(b.toString());
	  }
  }
  ...
  {
	  if(control.Control.isTracing("copyprop")){
		  System.out.println("========= block before copyprop========");
